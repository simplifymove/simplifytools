...
try:
    ...
    stdin, stdout, stderr = client.exec_command(f'python3 -m pip install --break-system-packages {package_name}', timeout=180)
    ...
    stdin, stdout, stderr = client.exec_command('python3 -m pip show statsmodels')
    ...
    # Import test
    stdin, stdout, stderr = client.exec_command('python3 -c "import statsmodels; print(f\'✓ statsmodels {statsmodels.__version__} imported successfully\')"')
