...
try:
    ...
    stdin, stdout, stderr = client.exec_command('python3 -m pip show scikit-learn')
    ...
    # Import test
    stdin, stdout, stderr = client.exec_command('python3 -c "import sklearn; print(f\'✓ scikit-learn {sklearn.__version__} imported successfully\')"')
