...
try:
    ...
    stdin, stdout, stderr = client.exec_command('python3 -m pip install python-dotenv')
    ...
    # Also test import
    stdin, stdout, stderr = client.exec_command('python3 -c "import dotenv; print(f\'python-dotenv version: {dotenv.__version__}\')"')
