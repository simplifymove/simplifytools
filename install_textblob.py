...
try:
    ...
    stdin, stdout, stderr = client.exec_command('python3 -m pip show textblob')
    ...
    # Import test
    stdin, stdout, stderr = client.exec_command('python3 -c "import textblob; print(f\'✓ textblob {textblob.__version__} imported successfully\')"')
