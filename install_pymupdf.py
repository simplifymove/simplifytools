...
try:
    ...
    print("[*] Checking if PyMuPDF is installed...")
    ...
    if 'not found' in error.lower() or 'WARNING' in output or output.strip() == '':
        print("[!] PyMuPDF not installed. Installing PyMuPDF==1.27.2.2...")
        
        # Install PyMuPDF 1.27.2.2
        stdin, stdout, stderr = client.exec_command('python3 -m pip install PyMuPDF==1.27.2.2')
        ...
        for line in output.split('\n'):
            if line.startswith('Version:'):
                ...
                print(f"[+] PyMuPDF already installed (version {version})")
        print(output)
