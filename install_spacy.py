...
try:
    ...
    stdin, stdout, stderr = client.exec_command('python3 -m pip show spacy')
    ...
    # Import test
    stdin, stdout, stderr = client.exec_command('python3 -c "import spacy; print(f\'✓ spacy {spacy.__version__} imported successfully\')"')
