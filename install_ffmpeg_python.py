...
try:
    ...
    stdin, stdout, stderr = client.exec_command('python3 -m pip show ffmpeg-python')
    ...
    # Import test
    stdin, stdout, stderr = client.exec_command('python3 -c "import ffmpeg; print(f\'✓ ffmpeg-python imported successfully\')"')
