...
try:
    ...
    print("[*] Installing reportlab==4.4.10 (with system package override)...")
    stdin, stdout, stderr = client.exec_command('python3 -m pip install --break-system-packages reportlab==4.4.10')
