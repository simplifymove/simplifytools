...
try:
    ...
    stdin, stdout, stderr = client.exec_command('python3 -m pip show seaborn')
    ...
    # Import test
    stdin, stdout, stderr = client.exec_command('python3 -c "import seaborn; print(f\'✓ seaborn {seaborn.__version__} imported successfully\')"')
