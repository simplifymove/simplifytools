...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://simplifyconvert.com/all-tools/converters/font-awesome-to-png',
  ...
  alternates: { canonical: 'https://simplifyconvert.com/all-tools/converters/font-awesome-to-png' },
};
