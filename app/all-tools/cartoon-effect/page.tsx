          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">
                How the Cartoon Effect works
              </h2>
              <p className="text-gray-600 leading-7">
The cartoon effect processes image pixels to simplify tonal
                regions and emphasize visible boundaries. This creates a
                stylized illustration-like appearance while retaining the
                basic structure of the source image.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="border border-gray-200 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-600 leading-6">
                  The result is a pixel-based visual effect; it does not redraw the source with a generative illustration model.
                </p>
              </div>
            </div>
