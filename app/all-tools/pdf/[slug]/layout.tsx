...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  ...
  const seoConfig: Record<string, { title: string; description: string; keywords: string[] }> = {
    ...
    'crop-pdf': {
      title: 'Crop PDF Online Free - Resize & Trim PDF Pages',
      description: 'Crop PDF pages online for free. Trim margins, resize pages, extract specific areas. Visual editor - no software needed. Preserve quality. Instant download.',
      keywords: ['crop PDF', 'crop PDF pages', 'PDF cropper online', 'resize PDF margins', 'crop PDF free', 'trim PDF online'],
    },
    'pdf-page-deleter': {
      title: 'Delete PDF Pages Online Free - Remove Unwanted Pages',
      description: 'Delete specific pages from PDF files online for free. Remove unwanted pages instantly with our easy-to-use tool. No software needed - instant download.',
      keywords: ['delete PDF pages', 'remove PDF pages', 'PDF page deletion', 'delete pages from PDF online', 'remove pages from PDF', 'delete PDF pages free'],
    },
    'create-pdf': {
      title: 'Create PDF from Images Online - Free Converter',
      description: 'Convert images (JPG, PNG, TIFF) to PDF online for free. Create PDFs from multiple images instantly. No software needed. Fast, secure processing.',
      keywords: ['create PDF from images', 'image to PDF converter', 'convert images to PDF', 'create PDF online', 'JPG to PDF', 'image to PDF online free'],
    },
    'protect-pdf': {
      title: 'Protect PDF with Password Online - Free & Secure',
      description: 'Add password protection to PDF files online for free. Password protect & secure your documents instantly with SSL encryption. No software needed.',
      keywords: ['protect PDF', 'password protect PDF', 'protect PDF online', 'PDF password protection', 'encrypt PDF', 'secure PDF online', 'password protected PDF'],
    },
    'unlock-pdf': {
