      ...
      <div className="relative bg-orange-500 py-16 px-4 md:px-8 overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-2 text-white/90 text-sm mb-6">
            ...
            <Link href="/all-tools" className="hover:text-white transition">Converters</Link>
            <ChevronRight size={16} />
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">PNG to JPG Converter</h1>
              <p className="text-lg text-white/90">Convert PNG images to JPG format with quality control. Perfect for reducing file sizes on photographs.</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-4">
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <p className="text-xs text-blue-700">
                    <strong>💡 JPG Benefits:</strong> Smaller file sizes, ideal for photographs and sharing.
                  </p>
                </div>
              </div>
            </div>
