      ...
      try {
        const downloadResult =
          await uploadBrowserDownloadResult({
            blob: result,
            toolSlug: 'pdf-to-jpg',
            originalName: 'converted.zip',
            outputName: 'converted.zip',
          });
        ...
        <div className="relative bg-orange-500 py-16 px-4 md:px-8 overflow-hidden">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">PDF to JPG</h1>
                <p className="text-lg text-white/90">Convert PDF pages to high-quality JPG images. Control DPI for print or web quality. Multi-page PDFs will convert each page as a separate image.</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="sticky top-4 space-y-4">
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 p-4">
                    ...
                    <div className="mb-4">
                      ...
                      >
                        <option value={150}>Web (150 DPI)</option>
