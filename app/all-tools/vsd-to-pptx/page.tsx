        ...
        <div className="relative bg-purple-500 py-16 px-4 md:px-8 overflow-hidden">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">VSD to PPTX</h1>
                <p className="text-lg text-white/90">Convert Visio diagrams to PowerPoint presentations. Preserve shapes, text, and formatting for professional presentations.</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="sticky top-4 space-y-4">
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 p-4">
                    ...
                    <button
                      ...
                      className="w-full bg-purple-500 hover:bg-purple-600 disabled:bg-gray-400 text-white font-semibold py-3 rounded-lg transition flex items-center justify-center gap-2"
                    >
                      {processing ? (
                        <>
