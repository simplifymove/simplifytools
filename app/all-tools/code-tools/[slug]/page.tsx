...
import { Copy, Download, RotateCcw, Play, ChevronRight, Zap, Shield, CheckCircle, Loader2, Database, Code2 } from 'lucide-react';
          ...
          >
            <div className="flex items-start gap-4 mb-4">
              <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                {React.createElement(getIconComponent(tool.icon), { size: 24, className: 'text-white' })}
              </div>
              <div>
