...
export default function CodeToolPage() {
  ...
  const actionText = getActionText(slug);
        ...
        <div className="flex-1">
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="space-y-3">
                  {relatedTools.map((relTool) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-600 mt-1">{relTool.description}</p>
                    </Link>
                  ))}
                </div>
              </motion.div>
            ...
            <motion.div
              ...
              className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 space-y-8"
            >
              {/* How To Use Section */}
              <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {relatedTools.map((relTool) => (
                <Link key={relTool.id} href={`/all-tools/code-tools/${relTool.id}`}>
                  ...
                  >
                    <h3 className="font-semibold text-gray-900 mb-2 group-hover:text-green-600">{relTool.title}</h3>
