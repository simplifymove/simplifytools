              ...
              >
                ...
                <div className="flex gap-2 flex-col sm:flex-row">
                  <div className="flex-1 relative group">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-pink-600 transition">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 rounded-full border-2 border-gray-200 hover:border-pink-300 focus:outline-none focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 transition-all duration-300 bg-white"
                    />
                  </div>
                  <button
                    type="submit"
                    className="px-8 py-3 bg-gradient-to-r from-pink-600 to-pink-700 text-white rounded-full font-medium hover:shadow-lg hover:shadow-pink-600/30 transition-all whitespace-nowrap flex items-center justify-center gap-2"
                  >
