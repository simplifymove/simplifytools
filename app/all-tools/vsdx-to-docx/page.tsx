...
export default function VsdxToDocxPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      setResult(url);
      setResultFileName(`diagram.docx`);
    } catch (error) {
        ...
        <div className="relative bg-blue-500 py-16 px-4 md:px-8 overflow-hidden">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">VSDX to DOCX</h1>
                <p className="text-lg text-white/90">Convert Visio VSDX diagrams to Word documents. Extract text, shapes, and formatting into editable DOCX files.</p>
              </div>
            </div>
          </div>
        </div>
