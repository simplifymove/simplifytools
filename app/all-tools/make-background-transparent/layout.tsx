...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://simplifyconvert.com/all-tools/converters/make-background-transparent',
  ...
  alternates: { canonical: 'https://simplifyconvert.com/all-tools/converters/make-background-transparent' },
};
