      ...
      <div className="bg-orange-500 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold mb-2">Make Background Transparent</h1>
              <p className="text-lg text-orange-50">
                Remove backgrounds and create transparent images with precision control
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:sticky lg:top-4">
            <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-6">Background Settings</h3>
              ...
              <div className="mb-6">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <span className="text-sm font-medium text-gray-700">Auto-detect Background Color</span>
                </label>
                <p className="text-xs text-gray-600 mt-2">
                  If unchecked, select the color manually below
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                />
                <p className="text-xs text-gray-600 mt-2">
                  Lower = more precise | Higher = removes more variations
                </p>
              </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                ...
                <li>• Auto-detect finds corner color</li>
                <li>• Adjust sensitivity as needed</li>
                <li>• Review preview for accuracy</li>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-purple-800 space-y-1">
                ...
                <li>• Increase sensitivity for gradients</li>
                <li>• Manual color picker for precision</li>
