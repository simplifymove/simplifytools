          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-lg text-white/90">Convert HEIC images to PNG format while preserving transparency with adjustable quality.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">Step 1: Upload HEIC File</h2>
                  <ImageUploader
                ...
                <div className="sticky top-4 space-y-4">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      ...
                      <li>• Supports HEIC and HEIF formats</li>
