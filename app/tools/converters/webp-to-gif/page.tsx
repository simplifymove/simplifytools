    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-100 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">WebP to GIF Converter</h1>
          <p className="text-lg text-gray-600">Convert WebP images to GIF format</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <form onSubmit={handleProcess} className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Upload WebP File</label>
                <div className="relative">
                  ...
                  <label
                    htmlFor="file-upload"
                    className="block w-full p-4 border-2 border-dashed border-green-300 rounded-lg cursor-pointer hover:border-green-500 transition text-center"
                  >
                    <Upload className="w-8 h-8 mx-auto text-green-500 mb-2" />
                    <span className="text-sm font-medium text-gray-700">
                      {file ? `${file.name}` : 'Click to upload WebP'}
                    </span>
                  </label>
                </div>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg border border-green-200 space-y-4">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-lg font-bold text-green-600">{options.fps}</span>
                  </div>
                  <input
                    type="range"
                    min={5}
              ...
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-green-600 to-teal-600 text-white font-bold rounded-lg hover:shadow-lg disabled:opacity-50 transition"
              >
                {processing ? (
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            {result && (
              <div>
                ...
                <img src={result} alt="Result" className="w-full h-64 object-cover rounded-lg border border-teal-300 shadow-md" />
                <button
            ...
            {!preview && !result && !error && (
              <div className="h-64 flex items-center justify-center bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                <p className="text-gray-400 text-center">Upload a WebP to see preview</p>
              </div>
            )}
          </div>
        </div>
