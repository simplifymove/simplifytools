        ...
        <div className="relative bg-orange-500 py-16 px-4 md:px-8 overflow-hidden">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">PSD to AI Converter</h1>
                <p className="text-lg text-white/90">Convert Adobe Photoshop files to Adobe Illustrator format for professional vector editing and design work.</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="sticky top-4 space-y-4">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      ...
                      <li>• Compatible with Adobe Illustrator</li>
                      <li>• Professional vector format</li>
