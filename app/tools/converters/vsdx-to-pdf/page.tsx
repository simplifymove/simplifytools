...
export default function VsdxToPdfPage() {
  ...
  const handleConvert = async () => {
    ...
    setError(null);
    try {
      const result = await convertImageFormat(file, 'application/pdf');
        ...
        <div className="relative bg-orange-500 py-16 px-4 md:px-8 overflow-hidden">
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">VSDX to PDF Converter</h1>
                <p className="text-lg text-white/90">Convert Visio VSDX diagrams to PDF format for universal compatibility and easy sharing.</p>
              </div>
            </div>
          </div>
        </div>
