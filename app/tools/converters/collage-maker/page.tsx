      ...
      <footer className="bg-slate-900 text-gray-300 mt-16">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h4 className="text-white font-bold mb-4">SimplifyTools</h4>
              <p className="text-sm">Your complete toolkit for image conversion and editing.</p>
            </div>
            <div>
              <h4 className="text-white font-bold mb-4">Categories</h4>
              <ul className="space-y-2 text-sm">
                <li><a href="/tools" className="hover:text-white transition">Image Tools</a></li>
                <li><a href="/tools" className="hover:text-white transition">Converters</a></li>
                <li><a href="/tools" className="hover:text-white transition">Editors</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-bold mb-4">Popular</h4>
              <ul className="space-y-2 text-sm">
                <li><a href="/tools" className="hover:text-white transition">Resize Image</a></li>
                <li><a href="/tools" className="hover:text-white transition">Compress Image</a></li>
                <li><a href="/tools" className="hover:text-white transition">JPG to PNG</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/tos" className="hover:text-white transition">Terms</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-700 pt-8">
            <p className="text-sm text-center">© 2026 SimplifyTools. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
