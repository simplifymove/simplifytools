        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-lg text-white/90">Convert PNG images to TIFF format with lossless compression. Perfect for archival and professional use.</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-4">
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <p className="text-xs text-blue-700">
                    <strong>💡 TIFF Benefits:</strong> Perfect for archival, professional printing, and lossless storage.
                  </p>
                </div>
              </div>
            </div>
