...
export default function PngToSvgPage() {
  ...
  const handleConvert = async () => {
    ...
    setError(null);
    try {
      const result = await convertImageFormat(file, 'image/svg+xml', {
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-lg text-white/90">Convert PNG images to scalable vector graphics with adjustable tracing parameters.</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-4 space-y-4">
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 p-4">
                    <h3 className="font-semibold text-gray-900 mb-4">Tracing Options</h3>
                    ...
                    <div className="mb-6">
                      ...
                      <input
                        ...
                        className="w-full"
                      />
                      <p className="text-xs text-gray-500 mt-1">Higher = fewer corner points</p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full"
                      />
                      <p className="text-xs text-gray-500 mt-1">Higher = smoother curves</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      ...
                      <li>• Advanced vector tracing</li>
                      <li>• Adjustable tracing parameters</li>
                      <li>• Supports PNG format</li>
