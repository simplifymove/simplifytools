      ...
      <div className="relative bg-orange-500 py-16 px-4 md:px-8 overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">VSDX to PPTX Converter</h1>
              <p className="text-lg text-white/90">Convert Visio VSDX diagrams and documents to PowerPoint PPTX format for easy sharing and presentation.</p>
            </div>
          </div>
        </div>
      </div>
