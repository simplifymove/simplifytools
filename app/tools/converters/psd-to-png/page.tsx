          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-lg text-white/90">Convert Photoshop PSD files to PNG images with transparency support and customizable compression.</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 p-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full"
                      />
                      <p className="text-xs text-gray-500 mt-1">0 = No compression, 9 = Maximum compression</p>
                    </div>
                  </div>
