    ...
    <main className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200 py-8 px-4 md:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 mt-2">Convert JPG images to PNG format with transparency support</p>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
                <p className="text-sm text-gray-600">
                  PNG format supports transparency and is lossless, making it ideal for graphics and images that need quality preservation.
                </p>
