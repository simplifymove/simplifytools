...
try:
    ...
    stdin, stdout, stderr = client.exec_command('python3 -m pip show langdetect')
    ...
    # Import test
    stdin, stdout, stderr = client.exec_command('python3 -c "import langdetect; print(\'✓ langdetect imported successfully\')"')
