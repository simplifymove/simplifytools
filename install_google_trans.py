...
try:
    ...
    stdin, stdout, stderr = client.exec_command(f'python3 -m pip install --break-system-packages {package_name}', timeout=60)
    ...
    stdin, stdout, stderr = client.exec_command('python3 -m pip show google-trans-new')
    ...
    # Import test
    stdin, stdout, stderr = client.exec_command('python3 -c "import google_trans_new; print(\'✓ google-trans-new imported successfully\')"')
