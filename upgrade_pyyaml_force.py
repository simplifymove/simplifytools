...
try:
    ...
    print("[*] Upgrading PyYAML to 6.0.3 (with system package override)...")
    stdin, stdout, stderr = client.exec_command('python3 -m pip install --break-system-packages --upgrade PyYAML==6.0.3')
